...
:Advanced menus: Menus with advanced features using, like templates, animations, drag-and-drop, etc.
...
.. |preview-enhancer| image:: ../_static/examples/enhancer.gif
.. |preview-enchant| image:: ../_static/examples/enchant.gif
...
.. csv-table::
	...
	"`Item enhancer <https://github.com/AbstractMenus/examples/blob/main/advanced/enhancer.conf>`_", "Nothing", |preview-enhancer|
	"`Random enchanter <https://github.com/AbstractMenus/examples/blob/main/advanced/enchanter.conf>`_", "Nothing", |preview-enchant|